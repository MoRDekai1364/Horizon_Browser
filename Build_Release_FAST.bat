...
dotnet publish Horizon.Stealth.csproj -c Release -r win-x64 --self-contained false -o "%OUT_DIR%" %ICON_ARG% -p:RunAnalyzers=false -p:GenerateDocumentationFile=false -p:DebugType=none -p:DebugSymbols=false
