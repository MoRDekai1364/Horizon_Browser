...
public partial class SettingsWindow : Window
{
    ...
    private void SettingsWindow_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        ThemeService.ApplyColorMode(this, SettingsService.Current.SettingsColorMode);
    }
    ...
    private void LoadVersionDisplay()
    {
        ...
        catch { TblVersionDisplay.Text = "VERSION UNREADABLE"; return; }
    ...
    private void LoadState()
    {
        ...
        CboTheme.SelectedIndex  = s.Theme == "Redmond" ? 1 : 0;

        ChkLinkColorModes.IsChecked = s.LinkSettingsAndSidebarColorMode;
        SetComboByTag(CboSettingsColorMode, s.SettingsColorMode);
        SetComboByTag(CboSidebarColorMode, s.LinkSettingsAndSidebarColorMode ? s.SettingsColorMode : s.SidebarColorMode);
        UpdateColorModeLinkVisibility();
        ...
        TxtGoogleClientId.Text     = s.GoogleClientId;
        TxtGoogleClientSecret.Text = s.GoogleClientSecret;
    ...
    private void BtnSave_Click(object sender, RoutedEventArgs e)
    {
        ...
        s.Theme = CboTheme.SelectedIndex == 1 ? "Redmond" : "Horizon";

        s.LinkSettingsAndSidebarColorMode = ChkLinkColorModes.IsChecked == true;
        s.SettingsColorMode = GetComboTag(CboSettingsColorMode);
        s.SidebarColorMode  = s.LinkSettingsAndSidebarColorMode ? s.SettingsColorMode : GetComboTag(CboSidebarColorMode);

        ThemeService.ApplyColorMode(this, s.SettingsColorMode);
        ThemeService.NotifySidebarColorModeChanged(s.SidebarColorMode);
        ...
        s.GoogleClientId     = TxtGoogleClientId.Text.Trim();
        s.GoogleClientSecret = TxtGoogleClientSecret.Text.Trim();
    ...
    private void UpdateColorModeLinkVisibility()
    {
        bool linked = ChkLinkColorModes.IsChecked == true;
        TblSettingsModeLabel.Text = linked ? "Settings & Sidebar" : "Settings Window";
        TblSidebarModeLabel.Visibility = linked ? Visibility.Collapsed : Visibility.Visible;
        CboSidebarColorMode.Visibility = linked ? Visibility.Collapsed : Visibility.Visible;
    }

    private void ChkLinkColorModes_CheckedChanged(object sender, RoutedEventArgs e)
        => UpdateColorModeLinkVisibility();
