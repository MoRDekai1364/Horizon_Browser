...
public partial class MainWindow : Window
{
    ...
    public MainWindow(string? startUrl = null, bool isWebApp = false)
    {
        ...
        ThemeService.SidebarColorModeChanged += (mode) =>
            Dispatcher.Invoke(() => ThemeService.ApplyColorMode(this, SettingsService.Current.SettingsColorMode));
...
");
    ...
    private void OpenMusicControlsPopup()
    {
        ...
        win.Closed += (s2, e2) => Dispatcher.BeginInvoke(new Action(() => { try { if (WindowState != WindowState.Minimized) Activate(); } catch { } }));
        win.Content = root;
        win.Show();
    }
