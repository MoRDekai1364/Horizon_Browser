...
public partial class BrowserView : UserControl
{
    ...
    private void CoreWebView2_NotificationReceived(object? sender, CoreWebView2NotificationReceivedEventArgs e)
    {
        ...
        Dispatcher.InvokeAsync(() =>
        {
            var toast = new Views.NotificationToast(origin, title, body);
            toast.Show();
        });
    }
    ...
    private void CoreWebView2_ContextMenuRequested(object? sender, CoreWebView2ContextMenuRequestedEventArgs e)
    {
        ...
        if (e.ContextMenuTarget.Kind == CoreWebView2ContextMenuTargetKind.Image)
        {
            ...
            downloadItem.CustomItemSelected += (s, args) =>
            {
                ...
                {
                    string script = $"var a = document.createElement('a'); a.href = '{uri}'; a.download = ''; document.body.appendChild(a); a.click(); document.body.removeChild(a);";
                    MainWebView.CoreWebView2.ExecuteScriptAsync(script);
                }
            };
