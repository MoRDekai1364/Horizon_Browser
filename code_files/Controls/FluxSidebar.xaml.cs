...
public partial class FluxSidebar : UserControl
{
    ...
    public FluxSidebar()
    {
        ...
        Unloaded += (_, _) => ThemeService.SidebarColorModeChanged -= OnSidebarColorModeChanged;
        ThemeService.SidebarColorModeChanged += OnSidebarColorModeChanged;
    }

    private void OnSidebarColorModeChanged(string mode)
        => Dispatcher.Invoke(() => ThemeService.ApplyColorMode(this, mode));

    

    private void FluxSidebar_Loaded(object sender, RoutedEventArgs e)
    {
        ThemeService.ApplyColorMode(this, SettingsService.Current.SidebarColorMode);
